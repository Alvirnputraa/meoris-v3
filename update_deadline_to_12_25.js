...
async function updateDeadline() {
  ...
  // Set deadline to 18 Nov 2025 12:25:00 WIB (UTC+7)
  // In UTC that's 18 Nov 2025 05:25:00
  const newDeadline = '2025-11-18 12:25:00+07'; // WIB timezone
  const newExpiredTime = Math.floor(new Date('2025-11-18T05:25:00Z').getTime() / 1000);
  ...
  console.log('New Deadline (WIB):', '18 November 2025 12:25:00');
  console.log('New Deadline (UTC):', new Date('2025-11-18T05:25:00Z').toISOString());
  console.log('='.repeat(80));
  ...
  console.log('='.repeat(80));
  console.log('Deadline (WIB):', '18 November 2025 12:25:00');
  ...
  console.log('='.repeat(80));
  console.log('\n1. Wait until after 12:25 WIB (deadline passes)');
  ...
  console.log('\n4. Verify:');
  console.log('   - Check website: https://meoris.id/user/purchase?view=notifications');
  console.log('   - Check order: https://meoris.id/user/purchase?view=order-detail&order=' + paymentRef);
  console.log('='.repeat(80));
}
