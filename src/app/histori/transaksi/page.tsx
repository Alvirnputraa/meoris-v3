            ...
            <aside className="absolute right-0 top-0 h-full w-80 md:w-96 max-w-[92%] bg-white shadow-2xl p-6 flex flex-col">
              ...
              <div className="mt-6 flex-1 overflow-y-auto">
                ...
                <div className="mt-2">
                  ...
                  <div className="mt-4"><Link href="/produk/detail-checkout" className="inline-flex items-center justify-center rounded-none border border-black bg-black text-white px-4 py-2 font-belleza text-sm hover:opacity-90 transition w-full">Checkout</Link></div>
                </div>
              </div>
            </aside>
          </div>
