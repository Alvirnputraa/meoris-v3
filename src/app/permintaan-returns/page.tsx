  ...
  return (
    <main>
        ...
        <div className="fixed inset-0 z-[80] flex items-center justify-center">
          ...
          <div className="relative bg-white rounded-lg shadow-2xl max-w-md w-full mx-4 p-6">
            <div className="text-center">
              ...
              <h3 className="font-heading text-lg md:text-xl text-black mb-3">
                Berhasil!
              </h3>
              ...
              <button
                ...
                className="w-full inline-flex items-center justify-center rounded-md bg-black text-white px-6 py-3 font-body text-sm hover:opacity-90 transition"
              >
                Oke
              </button>
            </div>
          ...
          <form className="mt-6 space-y-6" onSubmit={onSubmit}>
            ...
            <div>
              ...
              <input
                ...
                className="block w-full text-transparent file:mr-4 file:rounded-none file:border file:border-gray-300 file:bg-white file:px-4 file:py-2 file:text-sm file:text-black hover:file:bg-gray-50"
                aria-label="Unggah video dan foto unboxing"
              />
              {videoFiles.length > 0 && (
                <div className="mt-3 space-y-2">
                  {videoFiles.map((file, idx) => (
                    <div key={idx} className="flex items-center justify-between bg-gray-50 border border-gray-200 px-3 py-2 rounded-none">
            ...
            <div>
              <div className="flex items-center gap-2 mb-2">
                <label htmlFor="nomor" className="font-body text-sm text-black">
                  Nomor pesanan
                </label>
            ...
            <div className="pt-2">
              <button
                ...
                className="inline-flex items-center justify-center rounded-none bg-black px-5 py-3 font-body text-sm text-white hover:opacity-90 transition disabled:opacity-60 disabled:cursor-not-allowed"
      ...
      <footer className="bg-white py-14 md:py-16">
        <div className="max-w-7xl mx-auto pr-6 pl-12 md:pr-10 md:pl-40">
