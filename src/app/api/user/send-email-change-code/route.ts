...
export async function POST(req: Request) {
  try {
    ...
    const subject = 'Kode Verifikasi Perubahan Email - Meoris'
    const html = `
    <!DOCTYPE html>
    <html lang="id">
    <head>
      ...
      <title>Kode Verifikasi Perubahan Email</title>
      <style>
            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:#ffffff;border-radius:8px;overflow:hidden;">
              ...
              <tr>
                <td style="padding:20px 20px 8px 20px;">
                  <div style="font-family:Arial,Helvetica,sans-serif;color:#111111;font-size:18px;font-weight:700;">Kode Verifikasi Perubahan Email</div>
                </td>
              </tr>
              <tr>
                <td style="padding:0 20px;">
                  <div style="font-family:Arial,Helvetica,sans-serif;color:#333333;font-size:14px;line-height:20px;">
                    ...
                    <p style="margin:8px 0 0 0;">Kami menerima permintaan untuk mengubah alamat email akun Anda di Meoris. Gunakan kode berikut untuk melanjutkan:</p>
                  </div>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td style="padding:20px;">
                  ...
                  <div style="font-family:Arial,Helvetica,sans-serif;color:#777777;font-size:12px;line-height:18px;margin-top:12px;">
                    <p style="margin:0;">Jika Anda tidak merasa melakukan permintaan ini, abaikan email ini dan segera ubah password akun Anda.</p>
                  </div>
                </td>
              </tr>
            </table>
    ...
    return json({ ok: true, verificationId: insertRes.data.id })
  } catch (e) {
