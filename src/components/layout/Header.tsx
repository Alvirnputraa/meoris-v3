    ...
    <header className={headerClass}>
      <div className={containerClass}>
        ...
        <div className="flex items-center gap-4">
          ...
          <button className={iconButtonClass} aria-label="Search" onClick={() => isDocs && setIsSearchOpen(true)}>
            {isDocs ? (
              <>
                <Image src="/images/search.png" alt="Search" width={28} height={28} className="hidden md:inline" />
                <Image src="/images/search.png" alt="Search" width={26} height={26} className="md:hidden" />
              </>
            ) : (
          ...
          <div className="relative">
            ...
            >
              {isDocs ? (
                <>
                  <Image src="/images/favorit.png" alt="Favorites" width={28} height={28} className="hidden md:inline" />
                  <Image src="/images/favorit.png" alt="Favorites" width={22} height={22} className="md:hidden" />
                </>
              ) : (
          ...
          <div className="relative">
            ...
            >
              {isDocs ? (
                <>
                  <Image src="/images/cart.png" alt="Cart" width={28} height={28} className="hidden md:inline" />
                  <Image src="/images/cart.png" alt="Cart" width={22} height={22} className="md:hidden" />
                </>
              ) : (
          ...
          {/* User menu */}
          {!hydrated ? (
            <button className={iconButtonClass} aria-label="Login (loading)" disabled>
              {isDocs ? (
                <>
                  <Image src="/images/user.png" alt="User" width={28} height={28} className="hidden md:inline" />
                  <Image src="/images/user.png" alt="User" width={26} height={26} className="md:hidden" />
                </>
              ) : (
            ...
            <div className="relative" onMouseEnter={handleUserMenuMouseEnter} onMouseLeave={handleUserMenuMouseLeave}>
              <Link
                href="/my-account"
                className={`${iconButtonClass} ${!isDocs ? 'gap-2' : ''}`}
            ...
            <Link href="/login" className={iconButtonClass} aria-label="Login">
              {isDocs ? (
                <>
                  <Image src="/images/user.png" alt="Login" width={28} height={28} className="hidden md:inline" />
                  <Image src="/images/user.png" alt="Login" width={26} height={26} className="md:hidden" />
                </>
              ) : (
