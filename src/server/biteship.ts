...
const DEFAULT_ITEM_DIMENSIONS = {
  length: Number(process.env.BITESHIP_DEFAULT_ITEM_LENGTH || 20), // cm
  width: Number(process.env.BITESHIP_DEFAULT_ITEM_WIDTH || 15),
  height: Number(process.env.BITESHIP_DEFAULT_ITEM_HEIGHT || 10),
  weight: Number(process.env.BITESHIP_DEFAULT_ITEM_WEIGHT || 500) // grams per item
}
