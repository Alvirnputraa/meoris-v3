      ...
      {isMobileSidebarOpen && (
        <div className="md:hidden fixed inset-0 z-[70]">
          <div
            ...
            aria-hidden="true"
          />
          <aside className="absolute left-0 top-0 h-full w-80 max-w-[75%] bg-gradient-to-br from-white via-gray-50 to-gray-100 shadow-2xl transform transition-transform duration-500 ease-out animate-slideInLeft overflow-visible">
            ...
            <div className="relative bg-gradient-to-r from-black via-gray-900 to-black p-4 pt-6">
              ...
              <div className="flex items-start justify-between">
                ...
                <button
                  ...
                  onClick={() => {
                    // Navigate to notifications or open notification panel
                    setIsMobileSidebarOpen(false);
                    handleProtectedNavigation('/user/purchase?view=notifications');
                  }}
                >
                  ...
                  {/* Notification badge - optional, can show count */}
              ...
              <ul className="space-y-1 font-belleza">
                ...
                <li>
                  <button
                    ...
                    className="w-full group flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 text-gray-700 hover:text-black transition-all duration-200 bg-transparent border-0 cursor-pointer"
                  >
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" className="text-gray-600 group-hover:text-black">
                      <path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                      <path d="M3.27 6.96L12 12.01l8.73-5.05M12 22.08V12" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                    <span className="flex-1 text-sm text-left">Pesanan</span>
                  </button>
                </li>
                  ...
                  <li>
                    <div className="relative">
                      ...
                      >
                        ...
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={`transition-transform ${showMobileAccountMenu ? 'rotate-180' : ''}`}>
          ...
          <div className="max-w-[1160px] mx-auto px-6 md:px-8 lg:px-10">
            ...
            <div className="relative overflow-hidden rounded-xl px-4 md:px-6 py-6 md:py-8 lg:py-10">
              ...
              <canvas
                ref={(canvas) => {
                  ...
                  const drawPolygons = () => {
                    ...
                    for (let y = 0; y <= rows; y++) {
                      for (let x = 0; x <= cols; x++) {
                        const px = (x / cols) * w + (Math.random() - 0.5) * jitter;
                        const py = (y / rows) * h + (Math.random() - 0.5) * jitter;
                  ...
                  const drawTriangle = (a: {x: number; y: number}, b: {x: number; y: number}, c: {x: number; y: number}) => {
                    const base = 10 + Math.random() * 45;
                    const light = base + Math.random() * 25;
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4 md:gap-4">
              {latestLoading ? (
                ...
                <>
                  {[1, 2, 3, 4, 5].map((i) => (
                    <div key={i} className={`group ${i > 1 && i <= 3 ? 'hidden md:block lg:block' : i > 3 ? 'hidden lg:block' : ''}`}>
                ...
                latest.slice(0, 5).map((product: any, index: number) => (
                  <div
                    key={product.id}
                    className={`group ${index > 1 && index <= 3 ? 'hidden md:block lg:block' : index > 3 ? 'hidden lg:block' : ''}`}
                  >
                    <div className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
                      {/* Product Image */}
    ...
    <div className="grid grid-cols-1 md:hidden gap-4">
      ...
      <div className="pb-2">
        ...
        <ul className="mt-3 space-y-2 font-belleza text-gray-300 text-xs">
          ...
          <li><Link href="/docs/kebijakan-privacy" className="hover:underline hover:text-white">Kebijakan Privasi</Link></li>
        </ul>
      </div>
